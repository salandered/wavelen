...
- MIT, Copyright (c) 2013-present Cole Bemis, for `monitor`, `moon`, `music`, `square` and
  `circle-plus`, which Lucide derives from Feather. `circle-plus` is the `plus-circle` of the
  notice, renamed upstream.
